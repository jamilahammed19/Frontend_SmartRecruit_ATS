              ...
              notifications.map((notif) => (
                ...
                >
                  <div className="flex justify-between items-start mb-1.5">
                    <h4
                      className={`text-sm pr-4 ${!notif.is_read ? "font-bold text-slate-900" : "font-semibold text-slate-700"}`}
                    >
                      {notif.title}
                    </h4>
                    {/* Blue dot for unread */}
                  ...
                  <p
                    className={`text-xs mb-2 leading-relaxed ${!notif.is_read ? "text-slate-700" : "text-slate-500"}`}
                  >
                    {notif.message}
                  </p>

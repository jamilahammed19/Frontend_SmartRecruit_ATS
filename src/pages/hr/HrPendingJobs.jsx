  ...
  useEffect(() => {
    const fetchJobs = async () => {
      try {
        ...
        const processingJobs = jobsArray.filter(
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 font-sans">
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-2">
          These jobs have passed their deadline and require AI Candidate
          Selection.
        </p>
      </div>
      ...
      {pendingJobs.length === 0 ? (
        <div className="bg-white p-10 text-center rounded-xl border border-slate-200 text-slate-500">
          No pending jobs at the moment. All deadlines are in the future or

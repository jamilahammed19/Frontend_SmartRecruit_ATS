      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {loading ? (
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center flex flex-col items-center">
              ...
              <p className="text-slate-500 text-sm mt-1 mb-6">
                You haven't applied to any open positions.
              </p>
              <Link
                to="/find-jobs"
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 divide-y divide-slate-100">
              {recentApps.map((app) => (
                <div
                  key={app.id}
                  className="p-6 hover:bg-slate-50 transition-colors flex flex-col sm:flex-row sm:items-center justify-between"
                >
                  <div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex flex-col space-y-3">
            <Link
              to="/find-jobs"
              className="w-full flex items-center justify-between px-4 py-3 bg-slate-50 hover:bg-blue-50 border border-slate-100 hover:border-blue-200 rounded-xl transition-all group"
            >
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl shadow-sm p-6 text-white relative overflow-hidden">
            ...
            <p className="text-slate-300 text-sm mb-6 relative z-10 leading-relaxed">
              Complete your profile by adding your latest experiences and
              projects to boost your chances.
            </p>
            <Link
              to="/profile-edit"
              className="inline-flex w-full justify-center px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white text-sm font-medium rounded-lg backdrop-blur-sm border border-white/10 transition-colors relative z-10"
            >
              Edit Profile
            </Link>
          </div>
